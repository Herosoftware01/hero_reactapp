...
import { FaUserTag, FaUserFriends, FaCheckCircle } from 'react-icons/fa';
...
const Machine = () => {
    ...
    const fromChecking = location.state?.from === "checking";
    ...
    if (rollChecker.code) {
        const emp = employees.find(e => e.code === rollChecker.code);
        if (emp?.photo) {
    ...
    if (helper.code) {
        const emp = employees.find(e => e.code === helper.code);
        if (emp?.photo) {
                ...
                <div className="flex flex-col lg:flex-row space-y-4 lg:space-y-0 lg:space-x-8 p-10 bg-white/70 rounded-2xl shadow-3xl backdrop-blur-sm min-w-[300px] lg:min-w-[900px] border border-white/20">
                    ...
                    <div className="flex-1 p-8 rounded-xl shadow-lg flex flex-col space-y-4 border border-gray-100">
                        <div className="text-center">
                            ...
                            <div
                                className="w-[80px] h-[80px] rounded-full p-[4px] mx-auto flex items-center justify-center bg-origin-border bg-clip-content mb-3"
